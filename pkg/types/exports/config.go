...
func getApprovaltxsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Overview", Key: "fromName", Type: "string"},
		{Section: "Overview", Key: "to", Type: "address"},
		{Section: "Overview", Key: "toName", Type: "string"},
		{Section: "Overview", Key: "value", Type: "wei"},
		{Section: "Gas", Key: "gasOut", Type: "gas"},
...
func getAssetsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Asset", Key: "assetName", Type: "string"},
		...
		{Section: "Summary", Key: "gasOut", Type: "gas", NoTable: true},
		...
		{Section: "Asset", Key: "accountedForName", Type: "string", NoTable: true},
		{Section: "Summary", Key: "calcs.reconciled", Type: "checkmark"},
		...
		{Section: "Details", Key: "senderName", Type: "string", NoTable: true},
		{Section: "Details", Key: "recipient", Type: "address", NoTable: true},
		{Section: "Details", Key: "recipientName", Type: "string", NoTable: true},
...
func getOpenapprovalsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Details", Key: "ownerName", Type: "string"},
		{Section: "Details", Key: "token", Type: "address"},
		{Section: "Details", Key: "tokenName", Type: "string"},
		{Section: "Details", Key: "spender", Type: "address"},
		{Section: "Details", Key: "spenderName", Type: "string"},
...
func getReceiptsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Context", Key: "fromName", Type: "string"},
...
func getTracesFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "General", Key: "action"},
		{Section: "General", Key: "result"},
		{Section: "Articulation", Key: "articulatedTrace", NoTable: true},
		{Section: "Articulation", Key: "compressedTrace", Type: "string", NoTable: true},
		{Section: "General", Key: "timestamp", Type: "timestamp"},
		{Section: "General", Key: "date", Type: "datetime"},
		{Section: "", Key: "actions", Type: "actions", NoDetail: true},
	}
	types.NormalizeFields(&ret)
	return ret
...
func getTransactionsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Overview", Key: "to", Type: "address"},
		{Section: "Overview", Key: "toName", Type: "string"},
		{Section: "Overview", Key: "value", Type: "ether"},
		{Section: "Gas", Key: "gasOut", Type: "gas"},
		{Section: "Overview", Key: "date", Type: "datetime", NoTable: true},
		{Section: "Overview", Key: "timestamp", Type: "timestamp", NoTable: true},
		{Section: "Overview", Key: "input", Type: "bytes", NoTable: true},
		{Section: "Overview", Key: "articulatedTx", NoTable: true},
		{Section: "Overview", Key: "isError", Type: "boolean", NoTable: true},
		...
		{Section: "Gas", Key: "maxPriorityFeePerGas", Type: "gas", NoTable: true},
		{Section: "Context", Key: "blockHash", Type: "hash", NoTable: true},
		{Section: "Receipt", Key: "receipt.contractAddress", Type: "address", NoTable: true},
		{Section: "Receipt", Key: "receipt.contractAddressName", Type: "string", NoTable: true},
		{Section: "Receipt", Key: "receipt.status", Type: "value", NoTable: true},
		{Section: "Receipt", Key: "receipt.logs", NoTable: true},
		{Section: "Traces", Key: "traces", NoTable: true},
		{Section: "Details", Key: "nonce", Type: "value", NoTable: true},
		{Section: "Details", Key: "type", Type: "string", NoTable: true},
		{Section: "", Key: "actions", Type: "actions", NoDetail: true},
	}
...
func getTransfersFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "General", Key: "assetName", Type: "string"},
		{Section: "General", Key: "sender", Type: "address"},
		{Section: "General", Key: "senderName", Type: "string"},
		{Section: "General", Key: "recipient", Type: "address"},
		{Section: "General", Key: "recipientName", Type: "string"},
...
func getWithdrawalsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Details", Key: "addressName", Type: "string"},
