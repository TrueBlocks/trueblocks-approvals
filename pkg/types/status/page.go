...
func (c *StatusCollection) GetPage(
	...
	case StatusChains:
		...
		page.ExpectedTotal = facet.ExpectedCount()
	default:
		return nil, types.NewValidationError("status", payload.DataFacet, "GetPage",
...
func (c *StatusCollection) generateSummariesForPeriod(dataFacet types.DataFacet, period types.Period) error {
	// TODO: Use this
	_ = period
	switch dataFacet {
	// EXISTING_CODE
